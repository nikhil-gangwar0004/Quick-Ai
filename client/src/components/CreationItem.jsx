...
const CreationItem = ({item}) => {
    const [expended, setExpanded] = useState();
  return (
    <div onClick={()=>setExpanded(!expended)} className='p-4 max-w-5xl text-sm bg-white borer border-gray-200 rounded-lg cursor-pointer'>
